...
export const modules: Module[] = [
  {
    ...
    date: 'Miércoles 22 de abril · 17:30 a 19:30',
    duration: '2 horas',
    description:
    ...
    url: 'https://github.com/JavierStark/CursoDevOpsCloud_Docker',
    speakers: [
      {
  ...
  },
  {
    ...
    date: 'Miércoles 29 de abril · 17:30 a 19:30',
    duration: '2 horas',
    description:
    ...
    url: 'https://catalog.us-east-1.prod.workshops.aws/join?access-code=efc5-059361-59',
    speakers: [
      {
  ...
  },
  {
    ...
    date: 'Miércoles 6 de mayo · 17:30 a 19:30',
    duration: '2 horas',
    description:
    ...
    url: 'https://github.com/JavierStark/CursoDevOpsCloud_Kubernetes',
    speakers: [
      {
  ...
  },
  {
    ...
    date: 'Miércoles 13 de mayo · 17:30 a 19:30',
    duration: '2 horas',
    description:
    ...
    resources: [
      {
        label: 'Repositorio Primera Parte',
        url: 'https://github.com/alexcerezo/hello-github-actions',
      },
      {
        label: 'Repositorio Segunda Parte',
        url: 'https://github.com/deors/workshop-platform-eng',
      },
    ],
    speakers: [
      {
